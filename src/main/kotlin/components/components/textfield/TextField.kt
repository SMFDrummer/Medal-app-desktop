...
import components.components.textfield.base.LabelBottomPadding
...
import components.components.textfield.base.containerOutline
...
object TextFieldDefaults {
    ...
    fun colors(): TextFieldColors {
        return TextFieldColors(
            ...
            focusedContainerColor = MedalTheme.colors.surface,
            unfocusedContainerColor = MedalTheme.colors.surface,
            disabledContainerColor = MedalTheme.colors.disabled,
            errorContainerColor = MedalTheme.colors.surface,
            cursorColor = MedalTheme.colors.primary,
            errorCursorColor = MedalTheme.colors.error,
            textSelectionColors = LocalTextSelectionColors.current,
            focusedOutlineColor = MedalTheme.colors.transparent,
            unfocusedOutlineColor = MedalTheme.colors.transparent,
            disabledOutlineColor = MedalTheme.colors.transparent,
