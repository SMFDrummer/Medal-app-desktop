package components.components.progressindicators
...
object CircularProgressIndicatorDefaults {
    ...
    val TrackColor: Color
        @Composable get() = MedalTheme.colors.transparent
...
fun CircularProgressIndicatorPreview() {
    MedalTheme {
        Column(
            ...
            BasicText(text = "Determinate Progress", style = MedalTheme.typography.body1)
            CircularProgressIndicator(progress = 0.7f)

            BasicText(text = "Indeterminate Progress", style = MedalTheme.typography.body1)
