...
import components.components.NavigationBarDefaults.NavigationBarHeight
import components.components.NavigationBarItemDefaults.ItemAnimationDurationMillis
import components.components.NavigationBarItemDefaults.NavigationBarItemHorizontalPadding
import components.components.NavigationBarItemDefaults.NavigationBarItemVerticalPadding
import components.contentColorFor
import components.foundation.ProvideTextStyle
import components.foundation.systemBarsForVisualComponents
...
internal object NavigationBarDefaults {
    ...
    val containerColor: Color @Composable get() = MedalTheme.colors.background
...
object NavigationBarItemDefaults {
    ...
    @Composable
    fun colors(
        selectedIconColor: Color = MedalTheme.colors.onBackground,
        selectedTextColor: Color = MedalTheme.colors.onBackground,
        unselectedIconColor: Color = MedalTheme.colors.onBackground.copy(alpha = 0.65f),
        unselectedTextColor: Color = MedalTheme.colors.onBackground.copy(alpha = 0.65f),
        disabledIconColor: Color = MedalTheme.colors.onBackground.copy(alpha = 0.3f),
        disabledTextColor: Color = MedalTheme.colors.onBackground.copy(alpha = 0.3f),
    ...
    @Composable
    fun textStyle(): TextStyle = MedalTheme.typography.label2
}
