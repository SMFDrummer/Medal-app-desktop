...
import components.LocalTypography
...
object CardDefaults {
    ...
    fun cardColors(
        ...
        contentColor: Color = MedalTheme.colors.onSurface,
        disabledContainerColor: Color =
            MedalTheme.colors.disabled,
        disabledContentColor: Color = MedalTheme.colors.onDisabled,
    ): CardColors =
        CardColors(
    ...
    fun elevatedCardColors(
        containerColor: Color = MedalTheme.colors.background,
        contentColor: Color = MedalTheme.colors.onBackground,
        disabledContainerColor: Color =
            MedalTheme.colors.disabled,
        disabledContentColor: Color = MedalTheme.colors.onDisabled,
    ): CardColors =
